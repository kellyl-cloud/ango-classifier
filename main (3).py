...
def ango():
    ...
    url = f"{ANGO_BASE}/v2/project/{project}/tasks?page={page}&limit={limit}"
    if external_id:
        url += f"&externalId={urllib.parse.quote(external_id)}"
